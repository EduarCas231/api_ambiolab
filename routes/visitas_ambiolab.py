...
@visitam_bp.route('/<int:id>', methods=['PUT'])
...
@visitam_bp.route('/<int:id>', methods=['DELETE'])
...
@visitam_bp.route('/<int:id>', methods=['GET'])
...
@visitam_bp.route('/codigo/<string:codigo>', methods=['GET'])
...
@visitam_bp.route('/<int:id>/escaneado', methods=['PATCH'])
